...
class CSP(object):
    ...
    * var_to_const, a variable to set of constraints dictionary
    """
    def __init__(self,domains,constraints,cost):
...
# Constraint.max_display_level = 0  # display search trace (0 turns off)
# CSP.max_display_level = 0  # display search trace (0 turns off)