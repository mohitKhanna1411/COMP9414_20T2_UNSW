...
if __name__ == '__main__':
    ...
    mnb_sentiment.fit(X_train_bag_of_words, np.array(train['sentiment']))

    # predicting the results on test df
    y_pred = mnb_sentiment.predict(X_test_bag_of_words)
    # print(mnb_sentiment.predict_proba(X_test_bag_of_words))
    ...
    # plt.title('MNB - After lowercase')
    # plt.tight_layout()
    # plt.savefig('mnb_sentiment_lowercase.png')
    ######################################## SEABORN #######################################
